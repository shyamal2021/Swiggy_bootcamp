...
func HomePage(c *gin.Context) {
	c.JSON(200, gin.H{
		"message": "Hello World from GIN to Swiggy Homepage",
	})
}
...
func PostOrder (c *gin.Context) {
	...
	orders = append(orders,Order{104,string(content),"added later"})
...
func main() {
	...
	router.Run("localhost:5657") //ipaddress:8080/ping
}